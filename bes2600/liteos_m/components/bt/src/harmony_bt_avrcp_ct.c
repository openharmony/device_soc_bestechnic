 ...
 * @return return {@link BtProfileConnectState}
 * @since 3
 */
...
/*
 * @brief Establish connection with TG
 *
 * @param bdAddr bdAddr device address
 * @return return{@link BtStatus}
 * @since 3
 */
 ...
 *
 * @param bdAddr bdAddr device address
 * @param keyOperation,{@link AvrcpCtKeyOperation}
 * @return return{@link BtStatus}
 * @since 3
 */
 ...
 *
 * @param bdAddr bdAddr device address
 * @param param attributeId number and list，{@link AvrcpCtGetElementAttrPara}
 * @return return{@link BtStatus}
 * @since 3
 */
 ...
 *
 * After successfully registering events supported by TG, if the event changes, it will automatically notify CT。\n
 *
 * @param bdAddr bdAddr device address
 * @param eventId need TG notfily event ID，{@link AvrcpCtNotificationEventId}
 * @param interval Specifies the time interval (in seconds) at which the change in playback position will be notified.
 * This parameter is only used for event {@ link OHOS_AVRCP-EVENT_PLAYBack_POS_CHANGED}, and is ignored when registering other events.
 * @return return{@link BtStatus}
 * @since 3
 */
 ...
 *
 * @param bdAddr bdAddr device address
 * @param volume Absolute volume percentage{@link AvrcpCtAbsoluteVolume}
 * @return return{@link BtStatus}
 * @since 3
 */
...
int AvrcpCtSendVendorCmd(const BdAddr *bdAddr, bool is_press, unsigned short vendor_data_len, unsigned char *vendor_data)
{
    ...
    bes_status = btif_avrcp_send_pass_through_vendor_cmd(channel, is_press, vendor_data_len, vendor_data);
    return bes_status_to_ohos(bes_status);
}

/**
 * @brief Register Avrcp CT callback。
 *
 * @param func callback{@link BtAvrcpCtCallbacks}。
 * @return return{@link BtStatus}
 * @since 3
 */
