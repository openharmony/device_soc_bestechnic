...
void a7_trace_flush(void);
int a7_trace_output_to_fifo(const unsigned char* data, unsigned int size);
#else
...
int hal_trace_print_a7_tag_get_onoff(void);
