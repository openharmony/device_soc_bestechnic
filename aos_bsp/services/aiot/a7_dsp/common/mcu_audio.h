...
enum e_WAKEUP_TYPE_T {
    eWAKEUP_VAD = 1, // 0 is default and invalid
    eWAKEUP_KEY,
    eWAKEUP_TIMER,
    eWAKEUP_WIFI,
    eWAKEUP_BT,
...
void mcu_audio_vad_wakup(enum e_WAKEUP_TYPE_T type, int param);
enum e_WAKEUP_TYPE_T mcu_audio_vad_get_wakeup_type(int *param);
