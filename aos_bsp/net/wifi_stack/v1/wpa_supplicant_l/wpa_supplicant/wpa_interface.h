...
int  wpa_interface_add_network(struct bwifi_network_config *config);
int  wpa_interface_enable_network_id(int nid, int enable);
int  wpa_interface_enable_all_networks(int enable);
int  wpa_interface_modify_network(struct bwifi_config_item *item);
int  wpa_interface_count_networks(void);
int  wpa_interface_get_networks(struct bwifi_network_info *network, int count);
int  wpa_interface_nv_add_network(struct bwifi_network_config *config);
int  wpa_interface_nv_read_network(struct bwifi_network_config *config, int count);
int  wpa_interface_nv_find_network_by_ssid(const char *ssid, struct bwifi_network_config *config);
int  wpa_interface_del_network(struct bwifi_network_config *config);
int  wpa_interface_del_all_networks(void);
...
int  wpa_interface_abort_scan(void);
...
int  wpa_interface_get_dev_addr(BWIFI_INTF_TYPE_T type, u8 *addr);
...
int wpa_interface_p2p_find(char *cmd);
...
int wpa_interface_p2p_group_add(char *cmd_buf);
int wpa_interface_p2p_group_remove(char *cmd_buf);
int wpa_interface_p2p_invite(char *cmd_buf);
int wpa_interface_p2p_disconnect(void);
int wpa_interface_p2p_cancel(void);
int wpa_interface_p2p_wps_pbc(char *cmd_buf);
int wpa_interface_p2p_remove_network(char *cmd_buf);
...
#endif
int wpa_interface_debug_log_level(char *level_str);
